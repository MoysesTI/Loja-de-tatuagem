    ...
    let validator = new Validator
        let formCadastro = {
            ...
            passwordconfirmationCadastro:() => document.getElementById("passwordconfirmation"),
        ...
        cadastro.addEventListener('click', function() {
            ...
            const passwordconfirmation = formCadastro.passwordconfirmationCadastro().value
                ...
                firebase.auth().createUserWithEmailAndPassword(
                    ...
                    let creatProfile = {
                        ...
                        fullname: formCadastro.firstnameUser().value + ' ' + formCadastro.secondnameUser().value,
